...
/// Default list archive base for this project (trailing slash optional).
pub const DEFAULT_LORE_BASE: &str = "https://lore.kernel.org/linux-nfs/";
...
///
/// `lore_base` is typically `https://lore.kernel.org/linux-nfs/` (with or without
